...
public class Demo
{
    ...
    public void sampleDemo()
    {
        ...
        FlashPinball flashPinball = new FlashPinball(200, 200, -7, 8, Color.ORANGE, 30, machine, bumperObjects, holeObjects, pinballObjects);
        ...
        for(int i = 0; i <= 4000; i++)
        {
            ...
            flashPinball.move();
            flashPinball.collisionCheck(bumperObjects, holeObjects, pinballObjects);
        }
    }
}
